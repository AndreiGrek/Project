            ...
            if (sPref.contains(isoPrice)
                ...
                if (!controlIsEmpty()) {
                    ...
                    calculator65Activity.getTextViewOnlyControl().setText("Контроли: \n" + Integer.parseInt(calculator65Activity.getEditTextControl().getText().toString()) + " наборов * "
                            ...
                            + df.format(Integer.parseInt(calculator65Activity.getEditTextControl().getText().toString()) * sPref.getFloat(contrPrice, 0)) + " BYN");
                    calculator65Activity.getTextViewAllResultControl().setText("Общая стоимость с контролями: " + df.format(allPriceControl) + " BYN");
